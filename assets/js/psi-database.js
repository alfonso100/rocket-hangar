...
let psi_database = [

    {
        ...
        content: `
        <li class="offscreen-images can-advise">
    ...
    },
    {
        ...
        content: `
        <li class="dom-size out-of-scope">
    ...
    },
    {
        ...
        content: `
        <li class="font-display can-advise">
    ...
    },
    {
        ...
        content: `
        <li class="total-byte-weight can-advise">
    ...
    },
    {
        ...
        content: `
        <li class="render-blocking-resources can-advise">
    ...
    },
    {
        ...
        content: `
        <li class="bootup-time can-advise">
    ...
    },
    {
        ...
        content: `
        <li class="mainthread-work-breakdown can-advise">
    ...
    },
    {
        ...
        content: `
        <li class="unused-javascript can-advise">
    ...
    },
    {
        ...
        content: `
        <li class="uses-long-cache-ttl can-advise">
...

    {
        ...
        content: `
        <li class="third-party-summary can-advise">
    ...
    },
    {
        ...
        content: `
        <li class="uses-rel-preload can-advise">
    ...
    },
    {
        ...
        content: `
        <li class="uses-rel-preconnect can-advise">
    ...
    },
    {
        ...
        content: `
        <li class="uses-text-compression can-advise">
    ...
    },
    {
        ...
        name: 'Minify CSS',
        content: `
        <li class="unminified-css can-advise">
    ...
    },
    {
        ...
        content: `
        <li class="unminified-javascript can-advise">
    ...
    },
    {
        ...
        content: `
        <li class="uses-passive-event-listeners out-of-scope">
    ...
    },
    {
        ...
        content: `
        <li class="no-document-write out-of-scope">
    ...
    },
    {
        ...
        content: `
        <li class="critical-request-chains out-of-scope">
    ...
    /*
    {
        ...
        content: `
        <li class="resource-summary can-advise">
    ...
    },*/
    {
        ...
        content: `
        <li class="redirects out-of-scope">
            <a href="https://docs.wp-rocket.me/article/1388-avoid-multiple-page-redirects">Avoid Multiple Page Redirects</a> [CHECK IF IT HAPPENS WITH WPR BYPASSED]
        </li>`,
        destination: 'out-of-scope',
    ...
    },
    {
        ...
        content: `
        <li class="legacy-javascript out-of-scope">
    ...
    },
    {
        ...
        name: 'Use HTTP/2',
        content: `
        <li class="use-http-2 out-of-scope">
    ...
    },
    {
        ...
        content: `
        <li class="third-party-facades can-advise">
...

    {
        ...
        content: `
        <li class="preload-lcp-image can-advise">
